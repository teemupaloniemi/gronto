...
(list '( |Proof complexity| |Computational complexity and cryptography|)
      ...
      '( |Spatial-temporal systems| |Information systems applications| |Global positioning systems| |Location based services IS| |Sensor networks| |Data streaming| |Geographic information systems|)
